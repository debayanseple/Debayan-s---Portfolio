 ...
 * which is what keeps the eyebrow (UI/UX designer & / Frontend Developer) flush
 * with the P and 2026 flush with the final O at every viewport. On phones it
 * drops back into flow — see `.lockup` in globals.css for why.
 */
    ...
    <div className="lockup relative mx-auto w-fit">
      <div className="lockup-labels">
        <motion.p
          ...
          style={{ fontSize: hero.eyebrowSize, lineHeight: 1.05, whiteSpace: 'pre-line' }}
